...
clusters(1).stations(2).isCharged = false;
clear tempStations;
% cluster 2
...
assert(clusters(1).stations(2).cost == 0);
assert(clusters(1).stations(2).remDist == 0);
assert(clusters(2).stations(1).cost == 6);
assert(clusters(2).stations(1).remDist == 4);
